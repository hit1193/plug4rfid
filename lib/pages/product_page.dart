...
import 'package:excel/excel.dart' as excel_pkg; // 엑셀 출력을 위해 추가
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  _buildSectionHeader(Icons.star, "기본 정보", Colors.blue),
...
class _ManualInoutDialogState extends State<_ManualInoutDialog> {
  ...
  Widget _buildStyledField(String label, TextEditingController ctrl) {
    return TextField(controller: ctrl, decoration: InputDecoration(labelText: label, labelStyle: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13), border: const OutlineInputBorder(), contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 16)));
  }
  ...
  Widget _buildStyledDropdown(String label, String initial, List<String> items, ValueChanged<String?> onChanged) {
    return Padding(
        ...
        child: DropdownButtonFormField<String>(
            ...
            onChanged: onChanged,
            decoration: InputDecoration(labelText: label, labelStyle: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13), border: const OutlineInputBorder(), contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 14))));
  }
}